  ...
  return (
    <main data-nav-theme="light">
      {/* Figma dev-mode inspect: "My Work" is Inria Serif 36px/400 (was
          40px/700 — dev-mode showed a plain, non-bold weight). "Previously
          at" is Inter 20px/200 (Inter's Extra Light) at #6D6B6B, in a
          746px-fixed-width box on the Figma canvas — reproduced as a
          max-width instead of a hard width, so it can still wrap/shrink
          below that on narrow screens rather than overflowing. */}
      <section className="px-5 pt-24 pb-8 sm:px-8 lg:px-[68px]">
        <h1 className="font-serif text-[36px] font-normal text-black">My Work</h1>
