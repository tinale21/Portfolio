...
const FINDINGS = [
  {
    number: "01",
    text: "Figma users struggled to adapt to Framer's unfamiliar workflows and mental models.",
  },
  {
    number: "02",
    text: "Limited onboarding and hidden features made the platform difficult for first-time users.",
  },
  {
    number: "03",
    text: "Users want embedded guidance and real-time feedback over external resources.",
  },
];

export function FramerRedesignKeyFindings() {
  return (
