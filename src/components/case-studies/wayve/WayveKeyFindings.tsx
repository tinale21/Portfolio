...
const FINDINGS = [
  {
    number: "01",
    text: "Music discovery is increasingly driven by passive scrolling rather than intentional listening.",
  },
  {
    number: "02",
    text: "Gen Z and Gen Alpha seek stronger connections with artists beyond streaming.",
  },
  {
    number: "03",
    text: "Fans are more willing to pay for music experiences that feel personal and exclusive.",
  },
];

export function WayveKeyFindings() {
  return (
